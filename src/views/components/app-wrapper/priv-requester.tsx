...
import {getPublicKey, nip19} from 'util/nostr-utils';
import {DecodeResult} from 'util/nostr-utils';
...
const PrivRequiredDialog = (props: { data: any, onSuccess: (key: string) => void, onHide: () => void }) => {
    ...
    const handleSubmit = () => {
        ...
        if (userKey.startsWith('nsec')) {
            ...
            const key = Array.from(dec.data).map(b => b.toString(16).padStart(2, '0')).join('');
